...
struct MidwifeLoginView: View {
    let model: MidwifeLoginModel
    ...
    private var loginCard: some View {
        VStack(alignment: .leading, spacing: 14) {
            ...
            Text(model.forgotPasswordTitle)
                .font(.system(size: 12, weight: .medium))
                .foregroundStyle(model.accentColor.opacity(0.75))
    ...
    private func submitLogin() {
        ...
        Task {
            ...
            do {
                ...
                guard role == .midwife else {
                    errorMessage = "This account is not registered as a midwife. Please use the correct login."
                    return
                }
